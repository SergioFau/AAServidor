...
public class Coche
{
    ...
    public Coche(int id, string marca, string color, DateTime fechaEntrada, decimal precio, bool comprado, DateTime? fechaCompra, string idComprador, int caballos)
    {
        Id = id;
        Marca = marca;
        Color = color;
                ...
                if(respuesta == "S"){
                  ...
                  var usuario = Usuario.recogerUsuarioPorNombre(nombreUsuario);
                    if(coche.Precio > usuario.Dinero){
                        ...
                        coche.IdComprador = usuario.Nombre;
